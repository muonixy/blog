...
const localPlaylist = [
	{
		id: 1,
		title: "绊",
		artist: "Nightcore.Shiro",
		cover: "assets/music/cover/绊.webp",
		url: "assets/music/url/绊.mp3",
		duration: 271,
	},
	{
		id: 2,
		title: "SAKURA",
		artist: "生物股长",
		cover: "assets/music/cover/SAKURA.png",
		url: "assets/music/url/SAKURA.mp3",
		duration: 355,
	},
	{
		id: 3,
		title: "Yellow",
		artist: "",
		cover: "assets/music/cover/Yellow.png",
		url: "assets/music/url/Yellow.mp3",
		duration: 176,
	},
    {
        id: 4,
        title: "Lemonたぶん (大概)",
        artist: "",
        cover: "assets/music/cover/たぶん (大概).png",
        url: "assets/music/url/たぶん (大概).mp3",
        duration: 258,
    },
    {
        id: 5,
        title: "ミルクレープ (千层蛋糕)",
        artist: "",
        cover: "assets/music/cover/ミルクレープ (千层蛋糕).png",
        url: "assets/music/url/ミルクレープ (千层蛋糕).mp3",
        duration: 179,
    },
    {
        id: 6,
        title: "好きだから (因为我喜欢你)",
        artist: "",
        cover: "assets/music/cover/好きだから (因为我喜欢你).png",
        url: "assets/music/url/好きだから (因为我喜欢你).mp3",
        duration: 200,
    },
];
